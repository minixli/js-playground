...
- [**classic-experiments**](./experiments/classic)  
  Focused on ES3–ES5 features, legacy behavior, and core JavaScript mechanisms. Examples include:
  - Prototype inheritance patterns
  - Function context and `this` binding
  - Optional semicolons and automatic semicolon insertion
  - Unicode handling and serialization quirks

- [**modern-experiments**](./experiments/modern)  
  Focused on ES6+ features and modern JavaScript idioms. Examples include:
